        ...
        <section>
          <div className="p-4 sm:ml-72">
            <div className="p-4 rounded-t-md">
              <h2 className="text-2xl font-bold mb-5">Product</h2>
                ...
                <Dialog.Portal>
                  ...
                  <Dialog.Content className="z-[301] fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[650px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
                    ...
                    <fieldset className="mb-[15px] flex items-center gap-5">
                      ...
                      <textarea
                        className="text-black shadow-black focus:shadow-black inline-flex h-[105px] w-full flex-1 items-center justify-center rounded-[4px] px-[10px] text-[15px] leading-none shadow-[0_0_0_1px] outline-none focus:shadow-[0_0_0_2px] p-2"
                        id="username"
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                  ...
                  <tbody>
                    <tr className="bg-white border-b-2">
                      ...
                      <td className="px-6 py-4">KD Trey 5</td>
                      <td className="px-6 py-4">10</td>
                      <td className="px-6 py-4">Rp3.250.000</td>
                    ...
                    <tr className="bg-white border-b-2">
                      ...
                      <td className="px-6 py-4">SB Dunk Low Panda</td>
                      <td className="px-6 py-4">11</td>
                      <td className="px-6 py-4">Rp2.250.000</td>
                      <td className="px-6 py-4 text-green-500">Active</td>
                      <td className="px-6 py-4 text-blue-500">
                        <a href="#">Edit</a>
                      </td>
